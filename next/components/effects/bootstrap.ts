...
export const checkRoomSetting = ({ ui, room, notification }: RootStore, roomType: string, roomName: string) => {
...
// export const listenUserLeaveEvent = ({ notification }: RootStore) => {
//   log("listenUserLeaveEvent()");

//   const handleUserLeave = (event: BeforeUnloadEvent) => {
//     notification.showInfo("ユーザーがページを離れようとしています。");
//     console.log("コメダ珈琲店");
//   };

//   window.addEventListener("beforeunload", handleUserLeave, false);

//   return () => {
//     log("User leave listener removed");
